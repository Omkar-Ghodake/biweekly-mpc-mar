      ...
      <div className="relative w-screen h-screen">
        ...
        <div className="relative flex flex-col items-center justify-center h-full ">
          ...
          {selectedPlayer && (
            ...
            // </Modal>
            <Modal className="bg-transparent">
              <div class="relative w-full h-screen   flex justify-center items-end mx-auto">
                {/* Dark Gray Background (Below Diagonal) */}
                {/* <div
                ...
                <div class=" absolute z-1 bottom-96 right-24 transform -translate-x-1/2 flex items-center space-x-0">
                  <img
                    src={selectedPlayer.image}
                    class="w-auto h-45 rounded-b-4xl"
                  />
                </div>
                ...
                <>
                  ...
                  ></div>
                  {/* Triangle */}
                  <div class="absolute bottom-[150px]   h-0 border-l-[227px] border-r-[226px] border-t-[70px] top-101 border-l-transparent border-r-transparent border-t-gray-900 "></div>
                </>
                {/* <div

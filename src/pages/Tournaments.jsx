...
const Tournaments = () => {
  ...
  return (
    <div className="h-dvh  overflow-auto bg-[url('./assets/background.jpg')] bg-cover bg-center flex flex-col items-center py-10 px-6">
      ...
      {/* Tournament Cards */}
      <div className='flex flex-wrap justify-center items-center gap-10 w-full max-w-7xl h-full'>
        {tournaments.map((tournament) => (
          <div
            ...
            className='cursor-pointer relative bg-white/10 border border-white/30 backdrop-blur-lg px-6 rounded-2xl shadow-xl flex flex-col items-center w-[280px] transition duration-300 transform hover:scale-110 hover:shadow-2xl hover:border-green-400 hover:bg-white/20 object-cover h-[250px]'
          >
            <img
              src={tournament.logo}

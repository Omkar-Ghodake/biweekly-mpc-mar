          ...
          >
            <div className="flex flex-col text-[#1E4788]">
              <div className=" w-full h-[470px] flex flex-row">
                ...
                <div className="w-1/2">
                  <div className="h-2/3 flex flex-col justify-between items-center space-y-5">
                    <div className="flex justify-center bg-white items-center h-[35vh] w-[35vh] rounded-2xl drop-shadow-2xl relative mt-5">
                      <img
                        src={image || img}
                        alt="Profile"
                    ...
                    {isEditing && (
                      <span className="text-center bg-[#1E4788] hover:bg-[#1e3388] text-white text-xs px-2 py-1 rounded mb-10">
                        <label
                          htmlFor="imageUpload"
                          className={`${

      ...
      <div className='bg-white w-full max-w-sm mx-auto px-8 py-12 rounded-3xl  shadow-lg'>
        ...
        <div >
          ...
          <div className='flex justify-end'>
            <button onClick={openModal} className='text-black mt-1 text-sm hover:underline focus:outline-none'>
              Forgot password?
            </button>

            <Modal className="w-[500px] min-h-fit flex justify-center items-center"><ForgotPassword /></Modal>
          </div>

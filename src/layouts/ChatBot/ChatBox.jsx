...
const ChatBox = ({
  ...
  return (
    <div className='w-[30vw] h-[85vh] bg-gradient-to- from-blue-900/60 to-blue-950/60 rounded-xl text-white shadow-lg flex flex-col relative z-40 backdrop-blur-xl border border-blue-900 bg-amber-500'>
      <RxCross2
      ...
      {displayGreeting ? (
        <div className='flex flex-col items-center justify-center flex-1 text-center space-y-1 h-[80vh] bg-red-5'>
        ...
        <div></div>
        // <div className='flex flex-col flex-1 overflow-y-auto bg-red-500 h-[80vh]'>
        //   <div className='bg-gradient-to-b bg-transparent text-center text-lg font-semibold border-b border-gray-600 flex flex-col items-center z-30 h-[18%] bg-red'>

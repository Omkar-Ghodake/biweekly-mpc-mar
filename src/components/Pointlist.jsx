...
const Pointlist = ({ item, index }) => {
  ...
  return (
    <motion.div
      ...
      className="w-10/12 mx-auto p-2 bg-slate-200 transition-all duration-300 ease-in-out hover:bg-slate-300 hover:scale-102 hover:shadow-lg rounded-3xl grid grid-cols-6 text-center items-center shadow-md"
    >
